/// Этот список представляет типы файлов по умолчанию, которые поставляются
/// с ripgrep. В общем, любой формат файла подходит, хотя он обычно должен
/// быть ограничен разумно популярными открытыми форматами. Для других
/// случаев вы можете добавлять типы к каждому вызову ripgrep с помощью
/// флага '--type-add'.
///
/// Если вы хотите добавить или улучшить этот список, пожалуйста, создайте PR:
/// <https://github.com/BurntSushi/ripgrep>.
///
/// Пожалуйста, старайтесь держать этот список отсортированным лексикографически
/// и перенесённым на 79 столбцов (включительно).
#[rustfmt::skip]
