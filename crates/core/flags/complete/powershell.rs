/*!
Предоставляет автодополнения для CLI ripgrep для PowerShell.
*/
...
/// Генерирует автодополнения для PowerShell.
///
/// Обратите внимание, что эти автодополнения основаны на том, что было
/// произведено для ripgrep <=13 с использованием Clap 2.x. Улучшения этого
/// приветствуются.
