/*!
Предоставляет автодополнения для CLI ripgrep для оболочки fish.
*/
...
/// Генерирует автодополнения для Fish.
///
/// Ссылка: <https://fishshell.com/docs/current/completions.html>
